...
export const ServiceDiscovery = {
  DEVICE_SERVICE:
    process.env.DEVICE_SERVICE_URL || "http://localhost:3000/devices",
  DISCOUNT_SERVICE:
    process.env.DISCOUNT_SERVICE_URL || "http://localhost:3005/discounts",
  FULFILLMENT_SERVICE:
    process.env.FULFILLMENT_SERVICE_URL || "http://localhost:3008/fulfillments",
  INVENTORY_SERVICE:
    process.env.INVENTORY_SERVICE_URL || "http://localhost:3007/inventories",
};
